...
var CMap_1 = require("../../core/embedders/CMap");
var FontFlags_1 = require("../../core/embedders/FontFlags");
...
var CustomFontEmbedder = /** @class */ (function () {
    function CustomFontEmbedder(font, fontData, customName, fontFeatures) {
        ...
        this.allGlyphsInFontSortedById = function () {
            var glyphs = new Array(_this.font.numGlyphs);
            for (var idx = 0, len = glyphs.length; idx < len; idx++) {
                glyphs[idx] = _this.font.getGlyph(idx);
            }
